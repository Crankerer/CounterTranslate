...
_DEFAULTS: Dict[str, str] = {
    ...
    "log.hint_empty": "empty",
    "log.hint_notfound": "not found: {path}",
    ...
    "llm.error.unauthorized": "[LLM-Error] 401 Unauthorized — API key invalid or missing.",    "llm.error.timeout": "[LLM-Error] Timeout — LLM did not respond in time.",
    ...
    "settings.section.llm": "LLM / API",
    "settings.section.log": "Log & Performance",
    "settings.field.ui_lang": "UI language",
    "settings.field.target_lang": "Translate into",
    "settings.field.skip_langs": "Skip langs (comma-sep.)",
    "settings.field.ignore_players": "Ignore players (comma-sep.)",
    "settings.field.api_url": "API URL",
    "settings.field.model": "Model",
    "settings.field.temperature": "Temperature  (0.0 – 2.0)",
    "settings.field.api_key": "API key",
    "settings.field.api_key_file": "API key file",
    "settings.field.log_path": "console.log path",
    "settings.field.poll_interval": "Poll interval (ms)",
